    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('list_name', models.CharField(help_text='The name of the JISCMail mailing list to join', max_length=100)),
                ('joined_users', models.ManyToManyField(blank=True, editable=False, to=settings.AUTH_USER_MODEL)),
            ],
            options={
