...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("jasmin_notifications", "0001_squashed_0004_alter_notificationtype_level"),
    ]
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=9999,
                        help_text="Number defining where the category appears in listings. Categories are ordered in ascending order by this field, then alphabetically by name within that.",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "summary",
                    models.TextField(
                        help_text="One-line description of the service, shown in listings. No special formatting allowed."
                    ),
                ),
                (
                    "description",
                    models.TextField(
                        blank=True,
                        default="",
                        help_text="Full description of the service, shown on the details page. Markdown formatting is allowed.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Prevents the service appearing in listings unless the user has an active grant or request for it. The service details page will still be accessible to anybody who knows the URL.",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Check this box if manual intervention is required to enable or disable this service.<br>Registered approvers will receive an email when grants are revoked or expire.",
                    ),
                ),
                (
                    "position",
                    models.PositiveIntegerField(
                        default=9999,
                        help_text="Number defining where the service appears in listings. Services are ordered in ascending order by category, then by this field, then alphabetically by name.",
                    ),
                ),
                (
                    "category",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="form_join_set",
                        related_query_name="form_join",
                        to="jasmin_services.Service",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "group_dn",
                    models.CharField(
                        help_text="The LDAP group to use",
                        max_length=250,
                        unique=True,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="service_join_set",
                related_query_name="service_join",
                to="jasmin_services.Behaviour",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="behaviour_join_set",
                related_query_name="behaviour_join",
                to="jasmin_services.Service",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                related_name="polymorphic_jasmin_services.behaviour_set+",
