# Generated by Django 2.2.4 on 2020-10-16 12:33
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('jasmin_services', '0011_auto_20201016_1232'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='accesses', related_query_name='access', to='jasmin_services.Role')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('role__service__category__position', 'role__service__category__long_name', 'role__service__position', 'role__service__name', 'role__position', 'role__name'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('access', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='grants', related_query_name='grant', to='jasmin_services.Access')),
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='request', to='jasmin_services.Grant_new'),
        ),
        migrations.AddField(
            model_name='request',
            name='previous_grant',
        ...
        migrations.AddField(
            model_name='request',
            name='access',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requests', related_query_name='request', to='jasmin_services.Access'),
        ),
    ]
